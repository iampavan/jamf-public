...
# https://github.com/cocopuff2u/MacOS_Admin_Scripts/tree/main/Jamf_Only_Scripts/Jamf_Escrow_Scripts
#
...
function dialogCheck() {
    ...
    dialogURL=$(nscurl --location https://api.github.com/repos/swiftdialog/swiftdialog/releases/latest | \
        awk -F'"' '/browser_download_url/ {print $4}')
    ...
    if [[ ! -x "${dialogBinary}" ]]; then
        ...
        nscurl --location "$dialogURL" --output "${tempDirectory}/Dialog.pkg"
